...
<div class="nx-book">
	...
	<div class="nx-book-body">
		<div class="nx-book-perks">
			...
			<div class="nx-book-perk">✅ Pay online or on the day — no deposit</div>
			<div class="nx-book-perk">✅ Free cancellation up to 24h before</div>
		</div>
		<button type="button" class="nx-btn nx-btn--primary nx-btn--block" data-open-booking data-trip-id="<?php echo esc_attr( $excursion_id ); ?>" style="margin-bottom:10px">Book this excursion</button>
