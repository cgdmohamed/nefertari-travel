...
<a href="<?php echo esc_url( get_permalink() ); ?>" class="nx-card">
	<div class="nx-card-media" style="background:<?php echo esc_attr( nefertari_excursion_gradient_css( $excursion_id ) ); ?>">
		...
		<div class="nx-card-location"><?php echo esc_html( nefertari_excursion_location( $excursion_id ) ); ?></div>
	</div>
	<div class="nx-card-body">
		<h3 class="nx-card-title"><?php the_title(); ?></h3>
		<p class="nx-card-blurb"><?php echo esc_html( nefertari_excursion_blurb( $excursion_id ) ); ?></p>
		<div class="nx-card-foot">
			<div class="nx-card-duration"><?php echo nefertari_icon( 'clock', '#B07A55', 14 ); ?> <?php echo esc_html( nefertari_excursion_duration( $excursion_id ) ); ?></div>
