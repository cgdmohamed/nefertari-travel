...
<section class="nx-hero-section">
	...
	<div class="nx-hero">
		<div>
			<div class="nx-hero-badge"><span class="nx-hero-badge-dot"></span> Red Sea &amp; Nile Valley · Daily departures</div>
			<h1 class="nx-hero-title">
				Egypt, the way<br>you'd dream it<br>
				<span class="nx-gradient-text">— excursion by excursion.</span>
			</h1>
			<p class="nx-hero-text">From desert safaris and the Pyramids to coral reefs and the temples of Luxor — handpicked day trips with hotel pickup, expert guides and small groups.</p>
		...
		<div class="nx-hero-media">
			...
			<div class="nx-hero-float">
				...
				<div>
					<div class="nx-hero-float-title">Free hotel pickup</div>
					<div class="nx-hero-float-sub">Hurghada · Sahl Hasheesh · Makadi</div>
				</div>
			</div>
		</div>
	</div>
